...
var API_KEY = "live_Ah19BoCGywUynyo6SCTYZPkyMTrzefYYmZDlK2c6Ts2trXBt6FqFEK7kNMF6zmQr";
...
function _initialLoad() {
  _initialLoad = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var response, catBreeds, breeds, _breedSelect;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return fetch("https://api.thecatapi.com/v1/breeds/:breed_id");
        case 3:
          response = _context.sent;
          _context.next = 6;
          return response.json();
        case 6:
          catBreeds = _context.sent;
          // Access the array of breeds
          breeds = catBreeds.breedSelect;
          console.log(breeds);

          // Reference the breedSelect element
          _breedSelect = document.getElementById('.breedSelect'); // Create and append options for each breed
...
function _handleBreedSelect() {
  _handleBreedSelect = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var selectedBreedId, response, data, breedData, info, errorElement;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          selectedBreedId = breedSelect.value; // Retrieve information for the selected breed
          _context2.next = 4;
          return fetch("API_KEY =".concat(selectedBreedId));
        case 4:
        ...
        case 7:
          data = _context2.sent;
          // Clear any existing carousel items and info
          ...
          data.forEach(function (imageData) {
            ...
            image.alt = 'Image of ' + imageData.breeds[0].name;
            carouselItem.appendChild(image);
            carouselElement.appendChild(carouselItem);
          });
          // Create informational section with relevant breed data
          breedData = "https://api.thecatapi.com/v1/breeds/:breed_id/facts//";
          info = document.getElementById('infoDump');
          info.innerHTML = "\n      <h2>".concat(breedData.name, "</h2>\n      <p>Origin: ").concat(breedData.origin, "</p>\n      <p>Temperament: ").concat(breedData.temperament, "</p>\n      <p>Description: ").concat(breedData.description, "</p>\n    ");
        ...
        case 18:
          ...
          errorElement.textContent = 'Failed to retrieve breed information. Please try again later.';
          infoDump.appendChild(errorElement);
        case 25:
        case "end":
...
// Call handleBreedSelect initially to create the initial carousel
initialLoad();
...
//# sourceMappingURL=/carousel.d2a929f1.js.map